...
def model(rdz):
    ...
    if target_type=="name":
        ...
        rdz.submit(name=name, values=scenarios, write_key=MODEL_write_key, delay=delay)
        ...
        rdz.submit(name=zname, values=zscenarios, write_key=MODEL_write_key, delay=delay)
        name = zname
