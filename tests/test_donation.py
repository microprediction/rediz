...
def test_donate_remote():
    ...
    res1 = requests.post('https://www.microprediction.com/donations/' + write_key_1, data={'password': DONATION_PASSWORD,'donor':'Test'})
    res2 = requests.post('https://www.microprediction.com/donations/' + write_key_2, data={'password': DONATION_PASSWORD,'donor':'Test'})
